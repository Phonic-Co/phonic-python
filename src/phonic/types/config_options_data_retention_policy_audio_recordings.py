...
class ConfigOptionsDataRetentionPolicyAudioRecordings(UncheckedBaseModel):
    """
    ...
    transcripts: ConfigOptionsDataRetentionPolicyAudioRecordingsTranscripts
    audio_recordings: ConfigOptionsDataRetentionPolicyAudioRecordingsAudioRecordings
