...
class Phonic:
    ...
    reconnect_conversation_on_abnormal_disconnect : typing.Optional[bool]
        When True, the conversations WebSocket automatically reconnects and resumes after a non-deliberate disconnect (close codes 1006, 1012, or 1001/"restarting") using reconnect_conv_id. Defaults to False until stable in production.
